...
import { HomeMenu } from "@beautiful_web_theme_pr/home_menu/home_menu";
    ...
    start(env) {
        ...
        class HomeMenuAction extends Component {
            ...
            setup() {
                ...
                // The HomeMenu component takes care of rendering and searching apps.
                // In Enterprise, they pass apps here, but our custom HomeMenu reads them from the menu service directly.
                // We'll pass them down just in case, but HomeMenu handles it.
                this.homeMenuProps = {};
        ...
        async function toggle(show) {
            return mutex.exec(async () => {
                ...
                // wait for a tick to ensure that the url has been updated
